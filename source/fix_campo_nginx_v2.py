#!/usr/bin/env python3
"""
Fix campo nginx config:
- Remove the 302 redirect blocks that were sending all requests to /intranet
- Fix proxy Host headers back to campo.nix.local (port 80) and $host (HTTPS)
"""
import subprocess
...
NEW_CONFIG = r"""server {
    ...
    location / {
        ...
        proxy_set_header Host campo.nix.local;
...
print("Done. campo.urbantek.online and campo.nix.local should now serve the correct Vue SPA.")
